...
from app.db.models import Course as CourseModel, User, user_course_enrollment
...
class LMSService:
    ...
    async def enroll_user(self, user_id: int, course_id: str) -> bool:
    ...
    async def unenroll_user(self, user_id: int, course_id: str) -> bool:
