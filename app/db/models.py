...
from sqlalchemy import JSON, Boolean, Column, DateTime, Enum, ForeignKey, String, Table, Text
...
class Role(Base):
    ...
    role: RoleType = Column(Enum(RoleType), nullable=False)  # type: ignore[assignment]
